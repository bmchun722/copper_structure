...
gen = SlabGenerator(
    ...
    miller_index=(2, 1, 1),
    min_slab_size=6,          # <--- Set this to 2 (meaning 2 layers)
    min_vacuum_size=15.0,
    center_slab=True,
    lll_reduce=True,
    in_unit_planes=True       # <--- Add this!
)
slabs = gen.get_slabs()
cu_211_slab = slabs[0]
...
# 4. 3x4 Supercell
# surface unit cell
orthogonal_slab.make_supercell([[4, 0, 0], [1, 1, 0], [0, 0, 1]])

#cu_211_slab.make_supercell([[3, 0, 0], [0, 1, 0], [0, 0, 1]])
